...
public class LoginFrame extends javax.swing.JFrame {
    ...
    //public String logas=txtUsername.getText();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome To AGENT MATE");

        jLabel2.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        jLabel2.setText("Please login to the system");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnForgetPassword, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(112, 112, 112)
                .addComponent(btnExit)
                .addGap(21, 21, 21))
        );
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(x==0){
            loggedAs=txtUsername.getText();
            asWin.setTxtLogAs(loggedAs);
            System.out.println(loggedAs);
            //asWin.txtLogAs.setText(LoginFrame.loggedAs);
            //asWin.txtLogAs.setText(LoginFrame.loggedAs);
            this.dispose();
            asWin.pack();
            asWin.setLocationRelativeTo(null);
            asWin.setVisible(true);
            ...
            JOptionPane.showMessageDialog(this, "Error occured while checking username or password");
        }
