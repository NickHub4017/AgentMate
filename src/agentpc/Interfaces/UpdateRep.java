...
public class UpdateRep extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Update Rep details"));
        ...
        btnSubmit.setText("Save chanages");
    ...
    public void setFields(UserDetails rep){
        ...
        txtQuestion.setText(rep.getQuestion());
        txtAnswer.setText(rep.getAnswer());
    }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        std.setQuestion(txtQuestion.getText());
        std.setAnswer(txtAnswer.getText());
        
        
        if(dbops.updateUser("rep",std)){
